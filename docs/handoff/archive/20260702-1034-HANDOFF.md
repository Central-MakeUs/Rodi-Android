...
- Changed files: gradle/libs.versions.toml, core/common/build.gradle.kts, core/common/src/main/kotlin/com/dororong/rodi/core/common/RunSuspendCatching.kt, core/domain/build.gradle.kts, core/domain/src/main/kotlin/com/dororong/rodi/core/domain/RouteResult.kt, core/domain/src/main/kotlin/com/dororong/rodi/core/domain/CourseRepository.kt, core/domain/src/main/kotlin/com/dororong/rodi/core/domain/usecase/GetCoursesUseCase.kt, core/domain/src/main/kotlin/com/dororong/rodi/core/domain/usecase/GetRouteUseCase.kt, core/data/src/main/java/com/dororong/rodi/core/data/CourseRepository.kt, core/data/src/main/java/com/dororong/rodi/core/data/di/DataModule.kt, feature/home/src/main/java/com/dororong/rodi/feature/home/HomeViewModel.kt, feature/home/src/main/java/com/dororong/rodi/feature/home/HomeFormatters.kt, feature/home/src/main/java/com/dororong/rodi/feature/home/components/sheet/CourseDetailContent.kt, feature/home/src/main/java/com/dororong/rodi/feature/home/HomeScreen.kt, docs/handoff/HANDOFF.md
- Build/test: `./gradlew :core:domain:compileKotlin` GREEN, `./gradlew assembleDebug` GREEN, `./gradlew lint` GREEN
- Open questions: none

---
## Claude Review  <!-- Claude가 검토 후 채움 -->
- Blocking: 없음
- Nits: 없음 — diff가 Spec 코드블록과 파일 단위로 완전히 일치. Acceptance criteria 8개 전부 확인:
  `runSuspendCatching`이 `CancellationException`을 먼저 catch/rethrow, `CourseRepository` 인터페이스가
  `core:domain`으로 이동하고 `core:data`엔 `CourseRepositoryImpl`만 남음, `core/domain/build.gradle.kts`에
  `project(":core:data")` 없어 순환 의존 없음(직접 확인), `GetCoursesUseCase`/`GetRouteUseCase` 생성자
  주입 + `Result` 래핑, `HomeViewModel`이 UseCase만 주입받고 `naviPreferenceRepository`는 그대로 유지,
  `HomeScreen.kt`의 `GeoPoint → LatLng` 변환 2곳 정확히 반영. `./gradlew :core:domain:compileKotlin
  assembleDebug lint`를 직접 재실행해 GREEN 재확인(BUILD SUCCESSFUL). PROJECT.md 컨벤션 위반 없음
  (토큰 하드코딩/Material 아이콘/시크릿 노출/스코프 이탈 없음).
- Verdict: APPROVE
